...
public class KsmjActivity extends Activity{//技巧法规
	...
	private class OnClickListener implements View.OnClickListener{
			...
			public void onClick(View v) {
				...
				case R.id.keyimiji_b1:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_1Activity.class));
					break;
				case R.id.keyimiji_b2:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_2Activity.class));
					break;
				case R.id.keyimiji_b3:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_3Activity.class));
					break;
				case R.id.keyimiji_b4:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_4Activity.class));
					break;
				case R.id.keyimiji_b5:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_5Activity.class));
					break;
				case R.id.keyimiji_b6:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_6Activity.class));
					break;
				case R.id.keyimiji_b7:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_7Activity.class));
					break;
				case R.id.keyimiji_b8:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_8Activity.class));
					break;
				case R.id.keyimiji_b9:
					startActivity(new Intent().setClass(KsmjActivity.this, miji_9Activity.class));
					break;
