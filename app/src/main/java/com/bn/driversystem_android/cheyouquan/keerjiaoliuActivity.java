...
public class keerjiaoliuActivity extends Activity{//我的错题
	
	public static int CheYouQuan_KeEr=0;//是否从...界面进入 其他界面同理
	@Override
	protected void onCreate(Bundle savedInstanceState) {
				...
				if(Constant.LOGIN_OK==0)
				{
					...
					intent.setClass(keerjiaoliuActivity.this, Login_Begin_FromCheYouQuan.class);
					startActivity(intent);
					keerjiaoliuActivity.this.finish();
				}
				else
				{
